$(document).ready(function() {
    ...
    $("#btn-simpan").click(function() { // Ketika tombol simpan diklik
        // Buat variable data untuk menampung data hasil input dari form
        ...
        data.append('telp', $("#telp").val()); // Ambil data telp
        data.append('alamat', $("#alamat").val()); // Ambil data alamat

        // Ambil data foto yang dipilih pada form, dan masukan ke variable data
        ...
        $.ajax({
            ...
            type: 'POST', // Tentunya typenya POST atau GET
            ...
            success: function(response) { // Ketika proses pengiriman berhasil
                ...
                if (response.status == "sukses") { // Jika statunya = sukses
                     ...
                     * Lalu munculkan div pesan-suksesnya
                    ...
                    */
                    ...
                    /*
                     * Ambil pesan errornya dan set ke di pesan-error
    ...
    $("#btn-ubah").click(function() { // Ketika tombol ubah diklik
        // Buat variable data untuk menampung data hasil input dari form
        var data = new FormData();

        data.append('nis', $("#nis").val()); // Ambil data nis
        data.append('nama', $("#nama").val()); // Ambil data nama
        data.append('jenis_kelamin', $("#jenis_kelamin").val()); // Ambil data jenis_kelamin
        data.append('telp', $("#telp").val()); // Ambil data telp
        data.append('alamat', $('#alamat').val()); // Ambil data alamat

        // Cek apakah checkbox ubah foto diceklis
        if ($("#ubah_foto").is(":checked")) // Jika diceklis
        ...
        $.ajax({
            ...
            error: function (xhr, ajaxOptions, thrownError) { // Ketika terjadi errror
                alert(xhr.responseText); // Munculkan alert
            }
        });
    });
    ...
    $("#btn-hapus").click(function() { // Ketika tombol hapus di klik
        ...
        $.ajax({
            ...
            success: function(response) { // Ketika proses pengiriman berhasil
                ...
                /*
                 * Ambil pesan suksesnya dan set ke div pesan-sukses
                 * Lalu munculkan div pesan-sukses nya
                 * Setelah 10 detik, sembunyikan kembali pesan suksesnya
                 */
                $("#pesan-sukses").html(response.pesan).fadeIn().delay(10000).fadeOut();

                $("#delete-modal").modal('hide'); // Close / Tutup Dialog
            },
            error: function (xhr, ajaxOptions, thrownError) { // Ketika terjadi error
